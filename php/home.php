    ...
    <body>
       ...
       <div class="headerrow" >
                    ...
                    <div class="heading-cols" >
                        <div style="float:right;">
                               ...
                               <a href="voter_login.php"> <button name="Login" Value="Login" id="loginsignup"><b>Login</b></button>   </a>                         
                                ...
                                <a href="#"><input type="image" src="../Images/useraccount.png" width="38px" height="38px" id="profilebtn"></a>
        ...
        <div class="bodyrow">
            ...
            <!-- banner1 -->
            <div class="bodycols">
                <img src="../Images/banner5.jpg" alt="music award program" class="banner">

                <!-- vote now button -->
                <div>
                    <center>
                        <a href="voter_register.php" style="text-decoration:none; color:rgb(0, 0, 0);"><button type="Button" class="votebtn"><b>VOTE NOW !</b></a></button>
                    </center>
        ...
        <div class="bodyrow" style="margin-top:35px;">
            ...
            <!-- banner 5 -->
            <div class="bodycols">
                <img src="../Images/awardBanner1.webp" alt="drama award program" class="banner">
        ...
        <div >
            ...
            <div class="row">
                ...
                <p><i>Welcome to My Vote! We're so glad you're here!</i></p>
                </div>
                <div class="homewelcomedes"></div>
        ...
        <div class="row">
            ...
            <div class="bottomRegisterBtn">
                <a href="voter_register.php" style="text-decoration:none"><button type="button" id="signupvoterbtn"><span>Try as Voter</span></button></a>
            </div>
