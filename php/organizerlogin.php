...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/organizerlogin.css"> 
    ...
    <body>
       ...
       <div class="headerrow" >
        ...
        <div class="content">
            <h1 style = "font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">Log in  as an Organizer</h1>
            ...
            <div class="setpadding">
                ...
                <form action ="organizerValidation.php" method ="post">
         ...
         <div class="c">
            <a href="organizerRegister.php"><input type="button" Value="Creat your Account"  id="creataccount" ></a>
         </div>
                </form>
