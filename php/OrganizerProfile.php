...
require "config.php";
    ...
    $query = "SELECT * FROM organizer WHERE Organizer_ID = $sessionID";
...
<html>
    <head>
        ...
        <!-- link stylesheet -->
        <link rel="stylesheet" type="text/css" href="../css/orgnizerProfile.css">
        ...
        <!-- Nagvigation Bar -->
            ...
            <div class="row">
                ...
                <div style="width:18%;">
                    ...
                    <div class="nomineeprofiletext">Organizer Profile</div>
                ...
                <div style="width:40%;margin-top:80px;margin-left:180px;">
                    ...
                    <div class="textBoxRow1">
                        ...
                        <label for="Email" class="labelFont">Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </label>
                            <input type="email" name="email" class="firstRowTextbox" value = "<?php echo $email?>" readonly> 
                    ...
                    <div class="textBoxRow1">
                        ...
                        <label for="Email" class="labelFont">Contact No : </label>
                             <input type="phone" name="phone" class="firstRowTextbox" value = "<?php echo $pnumber?>" readonly> 
                    ...
                    <div class="textBoxRow1">
                         ...
                         <select id="country" name="country" style="width:430px;padding:10px; margin-top: 10px;margin-left: 10px;" disabled>
            ...
            <div class="row" style="margin-top:45px;margin-bottom: 80px;">
                <div class="secondRowColum">
                    ...
                    <!--Text box for organization name -->
                    <div style="margin-bottom:13px;">
                        <label for="organization_name" class="labelFont" style="margin-left:30px;">Organization Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                            <input type="text" name="organizationName" class="secondRowTextBox" value = "<?php echo $name ?>"readonly>
                    </div>


                    <!-- Organization adress text box -->
                    <div style="margin-bottom:13px;" >
                        <label for="Organization_address" class="labelFont" style="margin-left:30px;">Organization Address : </label>
                            <input type="text" name="orgAddress" class="secondRowTextBox" value = "<?php echo $address ?>"readonly>
                    </div>

                    <!-- User ID -->
                    <div style="margin-bottom:13px;"> 
                        <label for="userID" class="labelFont" style="margin-left:30px;">User ID <span style="margin-left: 130px;">:</span> </label>
                    ...
                    <!-- edit detils  button -->
                    <div>
                        <a href="organizerProfileEditable.php"><input type="submit" value="Edit" class="editbtn"></a>
                    </div>
                ...
                <div id="secondRow2Colum">
                    ...
                    <!-- reset password -->
                    <form action="organizerResetPassword.php" method="post">
