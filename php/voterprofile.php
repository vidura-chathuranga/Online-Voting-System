    ...
    <body>
       ...
       <div class="headerrow" >
        ...
        <!-- Nagvigation Bar -->
            ...
            <form action="voterprofileEditable.php" method="POST">
                <!-- Email text box -->
                    ...
                    <div class="textBoxRow1">
                         ...
                         <select id="country" name="country" style="width:430px;padding:10px; margin-top: 10px;margin-left: 10px;" readonly disabled>
                ...
                <div class="secondRowColum">
                    ...
                    <div style="margin-bottom:13px;">
                        <label for="users_name" class="labelFont" style="margin-left:30px;"> Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                            <input type="text" name="Name" class="secondRowTextBox" value = "<?php echo $name ?>" readonly>
                    </div>
                    ...
                    <div style="margin-bottom:13px;"> 
                        <label for="birthday" class="labelFont" style="margin-left:30px;">Birthday <span style="margin-left: 10px;">:</span> </label>
                            <input type="date" name="birthday" class="secondRowTextBox" value = "<?php echo $dob ?>" readonly>
                    </div>

                    <!-- for edit button -->
                    <div>
                        <input type="submit" name="edit" value="edit" class="savebtn">
                    </div>
