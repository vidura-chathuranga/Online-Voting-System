       ...
       <div class="headerrow" >
        ...
        <!-- Nagvigation Bar -->
            ...
            <div class="nav">
                ...
                <!-- admin user tab -->
                <li class="menu"><a href="admin_login.php" id="adminfloat">Admin Users</a></li>
            </div>
            ...
            <form action="organizerProfilesql.php" method="POST">
                <!-- Email text box -->
                ...
                <div class="secondRowColum">
                    ...
                    <div style="margin-bottom:13px;">
                        <label for="organization_name" class="labelFont" style="margin-left:30px;">Organization Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                            <input type="text" name="organizationName" class="secondRowTextBox" value = "<?php echo $name ?>">
                    </div>
                    ...
                    <div style="margin-bottom:13px;" >
                        <label for="Organization_address" class="labelFont" style="margin-left:30px;">Organization Address : </label>
                            <input type="text" name="orgAddress" class="secondRowTextBox" value = "<?php echo $address ?>">
                    </div>
